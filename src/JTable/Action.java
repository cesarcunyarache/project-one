...
public class Action extends javax.swing.JPanel {
    ...
    public Action(ModelAction data) {
        ...
        cmdEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().update(data.getElemento());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().delete(data.getElemento());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        cmdEdit = new JTable.Button();
        cmdDelete = new JTable.Button();
    ...
    private JTable.Button cmdDelete;
    private JTable.Button cmdEdit;
