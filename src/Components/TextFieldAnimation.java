...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/Components/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/Components/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/Components/loading.gif"));
